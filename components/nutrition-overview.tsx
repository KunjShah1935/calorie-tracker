  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h3 className="text-lg font-medium">Nutrition Overview</h3>
          <p className="text-sm text-muted-foreground">Analyze student nutrition data and identify trends</p>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Average per student per day</p>
        ...
        <TabsContent value="micronutrients">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Key vitamins and minerals intake across all students</CardDescription>
            </CardHeader>
            <CardContent className="h-[300px] flex items-center justify-center">
              <div className="flex flex-col items-center gap-2 text-muted-foreground">
        ...
        <TabsContent value="food-groups">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Distribution of food groups in student meals</CardDescription>
            </CardHeader>
            <CardContent className="h-[300px] flex items-center justify-center">
              <div className="flex flex-col items-center gap-2 text-muted-foreground">
                <PieChart className="h-8 w-8" />
